import { r as readable, w as writable } from './index2-95f6e5cd.js';

let valueLang = writable("Fluent");
let members = readable([
  {
...
let listOfTestimonialsData = readable([
  {
    name: "Feli",
    title: `"Feli from Germany" channel`,
    profile_image: "feli.jpg",
    feedback: "I was skeptical at first. But then I was blown away! I was speaking Spanish to a woman and was invited into her home - all while sitting in a coffee shop. Kleo lets you practice in everyday situations without ever leaving the country. This will boost your speaking confidence immensely!"
  },
  {
    name: "Peter",
...
export { andreaOffer as a, contents as c, faqs as f, listOfTestimonialsData as l, members as m, newsitems as n, valueLang as v };
//# sourceMappingURL=stores-05ea5ba6.js.map
